...
main (int argc, char *argv[])
{
  ...
  pcl::PointCloud<pcl::PointNormal>::Ptr cloud_wn(new pcl::PointCloud<pcl::PointNormal>);
  smooth(cloud, cloud_wn);

  pcl::PCDWriter writer;
  writer.write<pcl::PointNormal> ("smooth.pcd", *cloud_wn, false);

  // Create a search tree, use KDTreee for non-organized data.
  pcl::search::Search<PointNormal>::Ptr tree;
  if (cloud->isOrganized ())
  {
    tree.reset (new pcl::search::OrganizedNeighbor<PointNormal> ());
  }
  else
  {
    tree.reset (new pcl::search::KdTree<PointNormal> (false));
  }

  // Set the input pointcloud for the search tree
  tree->setInputCloud (cloud_wn);
  ...
  pcl::NormalEstimationOMP<PointNormal, PointNormal> ne;
  ne.setInputCloud (cloud_wn);
  ...
  copyPointCloud<PointNormal, PointNormal>(*cloud_wn, *doncloud);

  cout << "Calculating DoN... " << endl;
  // Create DoN operator
  pcl::DifferenceOfNormalsEstimation<PointNormal, PointNormal, PointNormal> don;
  don.setInputCloud (cloud_wn);
  ...
  range_cond->addComparison(pcl::FieldComparison<PointNormal>::ConstPtr(new pcl::FieldComparison<PointNormal>("normal_z", pcl::ComparisonOps::GT, threshold)));
  // Build the filter
